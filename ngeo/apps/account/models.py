...
class User(PermissionsMixin, CoreModel, AbstractBaseUser):
    ...
    staff_number = models.IntegerField(verbose_name=_("staff number"), max_length=30, blank=True, null=True)
    role = models.PositiveSmallIntegerField(choices=ROLE_CHOICES, blank=True, null=True, default=8)
